            ...
            <div id="content">
                ...
                <div class="container-fluid mt-4">
                    ...
                    <div class="container   mb-4">
                        <a class="btn btn-primary mb-4" href="#" role="button" data-toggle="modal"
                            data-target="#Modaltmbh">Tambah</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger"
                                                href="{{ route('adminkelolauser.destroy', $item->id) }}"
                                            ...
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('adminkelolauser.destroy', $item->id) }}"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('adminkelolauser.update', [$item->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="mb-3">
                    ...
                    <div class="container">
                        ...
                        <!-- Modal Tambah User-->
                        <div class="modal fade" id="Modaltmbh" tabindex="-1" role="dialog"
                            aria-labelledby="ModaltmbhlLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form id="addUserForm" action="{{ route('adminkelolauser.store') }}"
                                            method="POST">
                                            @csrf
                                            <div class="mb-3">
                                                <label for="username" class="form-label">Username</label>
