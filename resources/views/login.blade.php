...
<head>
    ...
    <style>
        ...
        .alert {
            transition: opacity 0.3s ease; /* Animasi transisi untuk alert */
        }
        ...
        .card {
            transition: transform 0.3s ease, box-shadow 0.3s ease; /* Animasi transisi untuk card */
        }

        .card:hover {
            transform: translateY(-10px); /* Efek mengangkat card saat hover */
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-flex align-items-center justify-content-center ">
                                <img src="img/undraw_mail_re_duel.svg" class="img-fluid" alt="Login Image">
                            </div>
